...
DELETE FROM revisao WHERE idRevisao=6;
...
DELETE FROM revisao WHERE idrevisao=24;
DELETE FROM revisao WHERE idrevisao=23;
...
ALTER TABLE revisao MODIFY dataHoraMarcacao CONSTRAINT nnRevisaoDataHoraMarcaco NOT NULL; 
