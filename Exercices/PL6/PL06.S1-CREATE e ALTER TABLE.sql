...
CREATE TABLE revisao (
    --idRevisao INTEGER GENERATED AS IDENTITY CONSTRAINT pkRevisaoIdRevisao    PRIMARY KEY,
    matricula CHAR(8),
    dataHoraMarcacao TIMESTAMP,
    efetuada CHAR(1) DEFAULT 'N' 
    CONSTRAINT nnRevisaoEfetuada NOT NULL,CHECK(REGEXP_LIKE(efetuada, '[SsNn]'))
);
...
-- ## alterar tabela Revisão ##
ALTER TABLE revisao ADD CONSTRAINT pkRevisaoMatriculaDataHoraMarcacao PRIMARY KEY(matricula,dataHoraMarcacao);
